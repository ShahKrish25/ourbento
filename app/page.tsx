  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-12">
      ...
      >
        ...
        <div className="relative z-10"> {/* Wrapper for content with z-index */}
          <motion.h1
          ...
          >
            Discover our premium bentonite products for various industrial applications.
          </motion.p>
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
          ...
          >
            <Link href="/products" className="bg-indigo-600 text-white px-8 py-4 rounded-full text-lg font-medium hover:bg-indigo-700 transition-all duration-300 transform hover:scale-105 inline-flex items-center group">
      ...
      <section className="mb-16">
        <h2 className="text-2xl sm:text-3xl font-semibold mb-6 text-center">Why Choose BentoMinerals?</h2>
      ...
      >
        <h2 className="text-2xl sm:text-3xl font-semibold mb-4 text-center">Ready to elevate your industrial processes?</h2>
        <p className="text-base sm:text-lg mb-8 text-center">
          Join the growing list of satisfied customers who trust BentoMinerals for their bentonite needs.
        </p>
        <div className="flex justify-center">
          <Link href="/contact" className="bg-white text-indigo-600 px-8 py-4 rounded-full text-lg font-medium hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 inline-flex items-center">
            Get in Touch
      ...
      <section className="mt-16">
        <h2 className="text-2xl sm:text-3xl font-semibold mb-6 text-center">Our Commitment to Quality</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <video src="https://cdn.pixabay.com/video/2023/02/15/150875-799327606_large.mp4" autoPlay loop muted className="h-full w-full object-cover" 
            style={{
              borderRadius: '13px',
          ...
          >
            <h3 className="text-xl sm:text-2xl font-semibold mb-4">Rigorous Quality Control</h3>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 mb-4">
              At BentoMinerals, we take pride in our commitment to delivering only the highest quality bentonite products. Our rigorous quality control process ensures that every batch meets our exacting standards.
            </p>
